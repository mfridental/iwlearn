...
from common import TestOfferSample, SimpleSampleFeature
...
class TestFixture():
    ...
    def test_expansion(self, capsys, caplog, monkeypatch):
        ...
        # Expand horizontally
        model_2 = ScikitLearnModel('TestModel', [SimpleSampleFeature('value_1'), SimpleSampleFeature('value_2')], TestOfferSample)
        caplog.clear()
        monkeypatch.setattr('__builtin__.input', lambda x: 'n') # do not remove parts with missing feature
